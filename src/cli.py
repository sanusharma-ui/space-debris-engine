...
#         norad_deb = int(input("NORAD ID of debris: "))

#         _, tle1_s, tle2_s = fetch_tle(norad_sat)
#         _, tle1_d, tle2_d = fetch_tle(norad_deb)

#         r_s, v_s = tle_to_state(tle1_s, tle2_s)
#         r_d, v_d = tle_to_state(tle1_d, tle2_d)
